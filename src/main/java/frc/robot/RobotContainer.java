...
public class RobotContainer {
  ...
  private Trigger R31 = m_firstDriverController.rightStick();
  ...
  //Auto
  //private final AutoDriveApril m_AutoDriveApril = new AutoDriveApril(0, 0.50, 0);
  //private final DriveAuto m_DriveAuto = new DriveAuto(m_drivetrainSubsystem, m_AutoDriveApril);
  ...
  R31.whileTrue(m_drivetrainSubsystem.DriveAuto());
  //yButton1.onTrue(m_drivetrainSubsystem.StraightGyro());
 ...
 L31.whileTrue(m_ArmSubsystem.setSetpoint(0.16)); // Intake / Modo Correr 1
    ...
    povDown2.whileTrue(m_ArmSubsystem.setSetpoint(0.12)); // Shoot
    povUp2.whileTrue(m_ArmSubsystem.setSetpoint(0.1677).unless(() ->  (m_LeftClimberSubsystem.LeftisUp() || m_RightClimberSubsystem.RightisUp()))); // Position 1: 90 degrees
    ...
    //yButton2.onTrue(m_ArmSubsystem.setAprilSetpoint());
    ...
    //yButton2.onTrue(ArmSubsystem.setAprilSetpoint()); //Intake return Note
    ...
    //xButton1.onTrue(m_AutoDriveApril.DriveAuto());
    configureBindings();
  }
  ...
  public Command getAutonomousCommand() {
    ...
    return new ParallelCommandGroup(m_drivetrainSubsystem.StraightApril(), 
    m_ArmSubsystem.setAprilSetpoint());
